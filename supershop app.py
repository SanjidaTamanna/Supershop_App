...
def total(self):
    ...
    total_snacks_price=(
                ...
                self.si+
                self.na)
    self.total_sna.set(str(total_snacks_price)+" BDT")
    self.a.set(str(round(total_snacks_price*0.05,3))+" BDT")
    ...
    self.total_gro.set(str(total_grocery_price)+" BDT")
    self.b.set(str(round(total_grocery_price*0.01,3))+" BDT ")
    ...
    self.total_hyg.set(str(total_hygine_price)+" BDT")
    self.c.set(str(round(total_hygine_price*0.10,3))+" BDT")
    ...
    self.total_all_bil=str(self.total_all_bill)+" BDT"
    billarea(self)
def intro(self):
    self.txtarea.delete(1.0,END)
    self.txtarea.insert(END,"\tWELCOME TO MONOXIDE'S SHOP\n\tPhone-No.-17288723--")
